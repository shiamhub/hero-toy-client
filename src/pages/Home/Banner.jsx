...
const Banner = () => {
    return (
        <div className='relative'>
            <img src={img3} alt="" />
            <div className='absolute top-5 lg:top-1/4 lg:ml-12 ml-5'>
                <h1 className='lg:text-7xl text-xl text-white font-bold'>Hero Toy</h1>
                <h6 className='text-white mt-0 lg:mt-4 w-1/3 lg:w-1/2'>The Robot is an action-packed toy that brings excitement and fun to children aged 5-10.</h6>
            </div>
